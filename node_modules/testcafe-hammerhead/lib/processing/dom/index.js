...
var IFRAME_FLAG_TAGS = TARGET_ATTR_TAGS.filter(function (tagName) {
    return tagName !== 'base';
}).concat('button');
...
var DomProcessor = function () {
    ...
    DomProcessor.prototype._processJsAttr = function _processJsAttr(el, attrName, _ref3) {
        var isJsProtocol = _ref3.isJsProtocol,
            isEventAttr = _ref3.isEventAttr;
