...
var PROPERTIES = exports.PROPERTIES = ['action', 'attributes', 'autocomplete', 'background', 'backgroundImage', 'background-image', 'borderImage', 'border-image', 'borderImageSource', 'border-image-source', 'cssText', 'cursor', 'data', 'firstChild', 'firstElementChild', 'formAction', 'href', 'innerHTML', 'innerText', 'lastChild', 'lastElementChild', 'listStyle', 'list-style', 'listStyleImage', 'list-style-image', 'location', 'manifest', 'nextElementSibling', 'nextSibling', 'onload', 'outerHTML', 'sandbox', 'style', 'text', 'textContent', 'which'];
