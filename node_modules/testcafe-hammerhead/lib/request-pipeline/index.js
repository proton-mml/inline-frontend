...
var specialPage = _interopRequireWildcard(_specialPage);
...
var stages = {
    ...
    4: function () {
        var _ref2 = _asyncToGenerator(function* (ctx, next) {
            if (ctx.isSpecialPage) ctx.destResBody = specialPage.getBody();else ctx.destResBody = yield (0, _http.fetchBody)(ctx.destRes);
