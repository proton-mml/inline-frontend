...
var TestRunController = function (_EventEmitter) {
    ...
    TestRunController.prototype.start = function () {
        var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(connection) {
            ...
            var testRun, hookOk, pageUrl, externalProxyHost, proxyBypassRules, externalProxySettings;
                ...
                while (1) {
                    switch (_context5.prev = _context5.next) {
                        ...
                        case 9:
                            ...
                            pageUrl = testRun.test.pageUrl;
                            externalProxyHost = this.opts.externalProxyHost;
                            proxyBypassRules = this.opts.proxyBypass && this.opts.proxyBypass.split(',');
                            ...
                            return _context5.abrupt('return', this.proxy.openSession(pageUrl, testRun, externalProxySettings));
