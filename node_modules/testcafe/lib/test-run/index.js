...
var TestRun = function (_Session) {
    ...
    TestRun.prototype._getPayloadScript = function _getPayloadScript() {
        ...
        return _mustache2.default.render(TEST_RUN_TEMPLATE, {
            ...
            browserStatusDoneUrl: (0, _stringify2.default)(this.browserConnection.statusDoneUrl),
    ...
    TestRun.prototype._getCurrentDriverTaskCommand = function _getCurrentDriverTaskCommand() {
        ...
        if (command.type === _type2.default.navigateTo && command.stateSnapshot) this.useStateSnapshot(JSON.parse(command.stateSnapshot));
        ...
        return _regenerator2.default.wrap(function _callee15$(_context15) {
            while (1) {
                switch (_context15.prev = _context15.next) {
                    ...
                    case 12:
                        return _context15.abrupt('return', { result: result, error: error });
